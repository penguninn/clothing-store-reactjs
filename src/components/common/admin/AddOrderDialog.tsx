...
interface AddOrderDialogProps {
  ...
  onAddOrder: (order: Omit<OrderType, "_id" | "createdAt" | "updatedAt">) => void;
}
...
const AddOrderDialog = ({ open, onOpenChange, onAddOrder }: AddOrderDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Create a new order in the system.</DialogDescription>
        </DialogHeader>
